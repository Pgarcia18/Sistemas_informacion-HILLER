...
<html>
    <head>
        ...
        <title>Hiller UI Elements</title>
    ...
    <body>
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><span>Hiller</span>Admin</a>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="registrousuarios.php"><em class="fa fa-calendar">&nbsp;</em> Usuarios</a></li>
