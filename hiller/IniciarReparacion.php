...
<html>
    <head>
        ...
        <title>Hiller - Iniciar Reparación</title>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">iNICIO DE REPARACION</li>
                </ol>
            </div><!--/.row-->

            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">INICIO DE REPARACION</h1>
                </div>
            </div><!--/.row-->
                ...
                <div class="col-md-6">
                    <div class="panel panel-defarequiredult">
                        <div class="panel-heading">
                            Registro de Inicio de Reparacion
                            ...
                            <form class="form-horizontal" action="" method="post">
                                <fieldset> 
                                 <div class="form-group">
                                            <label class="col-md-4 control-label" for="idMecanico">IdMecanico: </label>
                                            <div class="col-md-8">
                                                <input id="idMecanico" name="idMecanico" type="text" placeholder="IdMecanico" class="form-control" value="" required>
                                            </div>
                                        </div>
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                        <label class="col-md-4 control-label" for="fecini">Fecha de Inicio:</label>
                                        <div class="col-md-8">
                                            <input id="fecini" name="fecini" type="text" placeholder="Fecha de Inicio" class="form-control" value="<?php echo $hoy; ?>" required />
                                        </div>
                                    </div>
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="horaini">Hora: </label>
                                            <div class="col-md-8">
                                                <input id="horaini" name="horaini" type="text" placeholder="HH:MM" class="form-control" value="" required>
                                            </div>
                                        </div>
                                    <!-- Form actions -->
                                    <div class="form-group">
...
<!--                                            <input id="eliminar" type="submit" class="btn btn-default btn-md pull-right" name="Eliminar" value="Eliminar"/>
                        ...
                        if (isset($_POST['Enviar'])) {
                            ...
                            $feci = htmlspecialchars($_POST['fecini']);
                            $hini=htmlspecialchars($_POST['horaini']);
                            $mec=htmlspecialchars($_POST['idMecanico']);

                            $sqlG = "INSERT INTO `tblreparacion`( `fecha_inicio`, `hora_inicio`,`idmecanico`, `numero_serie`) "
                                    . "VALUES('" . $feci . "','" . $hini . "','" . $mec . "','" . $cod . "')";
                            $resG = mysql_query($sqlG, $link);
                            if ($resG) {
                                echo "<div class=\"alert alert-success\">Registro Guardado!!</div>";
                                echo "<meta http-equiv=\"Refresh\" content=\"2; url=IniciarReparacion.php\">";
                            } else {
